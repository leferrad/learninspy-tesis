...
% Director
\def\directorPortadaVal{\director}
\newcommand{\directorPortada}[1]{
\def\directorPortadaVal{#1}
}

% Codirector
\def\codirectorPortadaVal{\codirector}
\newcommand{\codirectorPortada}[1]{
	\def\codirectorPortadaVal{#1}
}
...
\textit{Memoria que presenta para optar al título de Ingeniero en Informática}  \\ [0.3em]%
...
\\ [1em]
\textit{Codirigida por el Ingeniero}  \\ [0.3em]
\textbf{\codirectorPortadaVal}
}
