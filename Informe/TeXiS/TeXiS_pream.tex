...
% [Agregado] Para hacer la tabla con checkmarks y xmarks (tilde y cruz)
\usepackage{amssymb}% http://ctan.org/pkg/amssymb
\usepackage{pifont}% http://ctan.org/pkg/pifont

% [Agregado] Package para enumerar con letras y otros formatos
\usepackage{enumerate}

% [Agregado] Package para escribir algoritmos y pseudocódigos
...
% [Agregado] Para escribir snippets de Python
% Default fixed font does not support bold face
\DeclareFixedFont{\ttb}{T1}{txtt}{bx}{n}{12} % for bold
\DeclareFixedFont{\ttm}{T1}{txtt}{m}{n}{12}  % for normal

% [Agregado] Para alinear dos figures en una linea (http://tex.stackexchange.com/questions/37581/latex-figures-side-by-side)
%\usepackage{graphicx}
\usepackage{subfig}
%\usepackage{caption}
...
%\usepackage[round]{natbib} % Cita entre parentesis
\usepackage{natbib}  % Cita entre corchetes
